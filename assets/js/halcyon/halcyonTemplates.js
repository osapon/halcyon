...
function mediaattachments_template2(status) {
  let media_views = "";
  var border = "";
  var mvfullheight = "";
  ...
  media_views = `
  <div class='media_views sensitive${mvfullheight}' media_length='${dsplength}'${border} data-height="${localStorage.getItem("image_size_tl")}">
  <div class='spoiler_button ${status.sensitive?'invisible':''}'></div>
