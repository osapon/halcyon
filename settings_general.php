...
<main id="main">
  ...
  <div class="article_wrap">
    ...
    <article class="center_column">
      ...
      <div class="timeline">
        <div style="float:left;width:30%;text-align:right;margin-top:16px">
          <h3><?=_('Default post privacy')?></h3>
        </div>
        <div class="post_privacy_wrap" style="float:left;width:70%;margin-top:8px;margin-bottom:-8px">
          <div class="radiobox">
            <input id="privacy-1" name="post_privacy" type="radio" value="public">
            <label for="privacy-1" class="radiotext"><?=pgettext('Option','Public')?></label>
          </div>
          <div class="radiobox">
            <input id="privacy-2" name="post_privacy" type="radio" value="unlisted">
            <label for="privacy-2" class="radiotext"><?=pgettext('Option','Unlisted')?></label>
          </div>
          <div class="radiobox">
            <input id="privacy-3" name="post_privacy" type="radio" value="private">
            <label for="privacy-3" class="radiotext"><?=pgettext('Option','Followers-only')?></label>
          </div>
          <div class="radiobox">
            <input id="privacy-4" name="post_privacy" type="radio" value="direct">
            <label for="privacy-4" class="radiotext"><?=pgettext('Option','Direct')?></label>
          </div>
        </div>
        <div style="float:left;width:30%;text-align:right;margin-top:16px">
          <h3><?=_('Mark as NSFW by default')?></h3>
        </div>
        <div class="post_sensitive_wrap" style="float:left;width:70%">
          <div class="switch">
        ...
        <div class="local_instance_wrap" style="float:left;width:70%">
        ...
        <div class="search_filter_wrap" style="float:left;width:70%;margin-top:8px;margin-bottom:-8px">
          <div class="radiobox">
        ...
        <div class="who_to_follow_wrap" style="float:left;width:70%">
          <div class="switch">
