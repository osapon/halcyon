...
font-size:12px;
font-weight:600;
content:"<?=_('Select file and upload')?>";
}
</style>
<main id="main">
  ...
  <div class="article_wrap">
    ...
    <article class="center_column">
      ...
      <div class="timeline">
        ...
        <div class="display_name_wrap" style="float:left;width:70%">
          <input name="display_name" type="text" class="disallow_enter textfield" id="setting_display_name" maxlength="30">
        </div>
        <div style="float:left;width:30%;text-align:right;margin-top:16px">
          <h3><?=_('About me')?></h3>
        </div>
        <div class="about_me_wrap" style="float:left;width:70%">
        ...
        <div class="avatar_wrap" style="float:left;width:70%">
        ...
        <div class="header_wrap" style="float:left;width:70%">
          <span class="halcyon_button uploadbtn" style="width:calc(50% - 2px);margin:10px;padding:0;height:28px;position:relative">
        ...
        <div class="lock_account_wrap" style="float:left;width:70%">
          <div class="switch">
