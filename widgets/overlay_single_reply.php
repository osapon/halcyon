      ...
      <div class="status_textarea">
        ...
        <div class="status_poll_editor invisible">
          ...
          <div style="float:right;margin-right:5px">
            <div class="poll_time"><input type="number" min="0" max="7" placeholder="0-7" class="poll_days"><?=_('Days')?></div>
    ...
    <div class="status_bottom">
      ...
      <div class="status_privacy status_option_button expand_privacy_menu_button">
        ...
        <div class="expand_privacy_menu invisible">
          ...
          <label for="single_reply_status_unlisted" class="status_privacy select_privacy disallow_select" privacyicon="fa fa-unlock">
